...
class GenerateCardWithCodePage  extends StatelessWidget {
  final int numbersPerRound;
  final String code;


  GenerateCardWithCodePage(
      { required this.numbersPerRound, required this.code,}) {
    GlobalCode = this.code;
  }
    ...
    return Scaffold(
      appBar: AppBar(
        title: const StrokeText(
          text: 'Cartela de Bingo', // Texto com contorno
          textStyle: TextStyle(
            fontFamily: 'Roboto',
            color: Colors.white,
            fontSize: 20,
        ...
        actions: [
          ...
          //  onPressed: () {
          //    // Chame a função para gerar o PDF da cartela
          //    generatePDF(card);
          //  },
          //),
        ],
      ...
      body: Column(
        children: [
          BingoCardOptions(), // Adicione as opções aqui
          Expanded(
            child: Center(
              child: BingoCard(maxNumber: numbersPerRound),
            ),
          ),
        ],
      ),
        ...
        Container(
          ...
          child: Column(
            children: [
              ...
              Container( // Adicionar um Container para o código no rodapé
                alignment: Alignment.bottomRight,
                margin: EdgeInsets.only(top: 16.0),
                child: strokedText(
                  ''+ GlobalCode + '', // Substitua por seu código real
                  TextStyle(
                    fontSize: 12, // Tamanho do texto no rodapé
